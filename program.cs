...
public class Program
{
    ...
    return;
            ...
            string wikipediaFilePath = "path/to/wikipedia.txt";
            
            string Wikipediainfo =File.ReadAllText("Wikipedia.txt"):
            // Use OpenAI API to generate a response based on user memory and message content
            var prompt = $"{(Wikipediainfo)} {memory} {message.Content}. (Act like you're Kyouko from Touhou Project .  (Don't read this aloud and dont talk about yourself in thirdperson or your name, use the context provided  to create a good reply))";
